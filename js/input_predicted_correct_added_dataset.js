...
// loader.load("model/kinect_banaoh.js", function(geometry, mats) {
  ...
  // filename[0] = "../datas/experiments/4s_datas/X_test_ki_" + motion + "_" + side + "_experiment_only_3degree_2nd_3rd_normalized.csv";
  // filename[0] = "../datas/experiments/4s_datas/one_euro_2/X_test_ki_" + motion + "_" + side + "_experiment_only_3degree_2nd_3rd_one_euro_filtering_using_all_bone_joints.csv";
  // filename[2] = "../datas/experiments/4s_datas/X_test_ki_" + motion + "_" + side + "_experiment_only_3degree_2nd_3rd_moving_averaged_using_all_bone_joints_qua_21contexts.csv";
  // filename[0] = "../datas/raw_datas/experiment/dataset/predicts/ki_" + motion + "_" + side + ".csv";
  filename[0] = "../datas/check/test_kinect_06.csv";


  // filename[3] = "../datas/experiments/only_datas/X_test_ki_" + motion + "_" + side + "_experiment_only_3degree_normalized.csv";
  // filename[3] = "../datas/experiments/4s_datas/X_test_ki_" + motion + "_" + side + "_experiment_only_3degree_2nd_3rd_normalized.csv";
  // filename[4] = "../datas/experiments/4s_datas/X_test_ki_" + motion + "_" + side + "_experiment_only_3degree_2nd_3rd_root_normalized.csv";
  // filename[5] = "../datas/experiments/4s_datas/X_test_ki_" + motion + "_" + side + "_experiment_only_3degree_2nd_3rd_one_euro_filtering_using_all_bone_joints.csv";
  
  // filename[5] = "../datas/experiments/only_datas/X_test_ki_" + motion + "_" + side + "_experiment_only_5degree_normalized.csv";
  // filename[6] = "../datas/experiments/4s_datas/X_test_ki_" + motion + "_" + side + "_experiment_only_5degree_2nd_3rd_normalized.csv";
  
  // filename[7] = "../datas/experiments/only_datas/X_test_ki_" + motion + "_" + side + "_experiment_only_7degree_normalized.csv";
  // filename[8] = "../datas/experiments/4s_datas/X_test_ki_" + motion + "_" + side + "_experiment_only_7degree_2nd_3rd_normalized.csv";
  ...
  // mesh[0].skeleton.bones[0].position.set(-8, 0, 0);
  // mesh[1].skeleton.bones[0].position.set(0, 0, 0);
  // mesh[2].skeleton.bones[0].position.set(8, 0, 0);

  // mesh[3].skeleton.bones[0].position.set(-8, -7, 0);
  // mesh[4].skeleton.bones[0].position.set(0, -7, 0);
  // mesh[5].skeleton.bones[0].position.set(8, -7, 0);

  // mesh[5].skeleton.bones[0].position.set(-4, -5, 0);
  // mesh[6].skeleton.bones[0].position.set(4, -5, 0);

  // mesh[7].skeleton.bones[0].position.set(-4, -20, 0);
  // mesh[8].skeleton.bones[0].position.set(4, -20, 0);
...
function render() {
  ...
  var q1 = new THREE.Quaternion().setFromEuler(new THREE.Euler(0,Math.PI/2,0));
  mesh[0].skeleton.bones[2].quaternion.copy(q1);
  ...
  // convert_kinect_to_three( motion_data[3][current_frame +10], mesh[3] );
  ...
  // convert_kinect_to_three( motion_data[5][current_frame + kinect_add_frame + both_add_frame ], mesh[5] );
  // convert_kinect_to_three( motion_data[5][current_frame + kinect_add_frame + both_add_frame ], mesh[5] );
  // convert_kinect_to_three( motion_data[6][current_frame + kinect_add_frame + both_add_frame ], mesh[6] );
  // convert_kinect_to_three( motion_data[7][current_frame + kinect_add_frame + both_add_frame ], mesh[7] );
  // convert_kinect_to_three( motion_data[8][current_frame + kinect_add_frame + both_add_frame  ], mesh[8] );
  // convert_kinect_to_three( motion_data[5][current_frame + kinect_add_frame + both_add_frame ], mesh[5] );

...
webglcamera.position.set(0, 5, 10);
...
loader.load("model/kinect_banaoh.js", function(geometry, mats) {
  ...
  // filename[1] = "../datas/predicted/X_test_kinect_17_position.csv";
  // filename[2] = "../datas/converted_data/mocap_17_cut_converted.csv";

  filename[0] = "../datas/converted_norot_dataset/kinect_17.csv";
  filename[1] = "../datas/predicted/X_test_kinect_17_position.csv";
  filename[2] = "../datas/converted_norot_dataset/mocap_17.csv";
  ...
  for (var i = 0; i < mesh.length; i++) {
    ...
    mesh[i].skeleton.bones[0].position.set(i*2-2, 0, 0);
...
function display_position( positionArray, mesh ) {
  ...
  for (var i = 0; i < positionArray.length/3; i++) {
    mesh.skeleton.bones[i].position.x = parseFloat(positionArray[i*3]);
    mesh.skeleton.bones[i].position.y = parseFloat(positionArray[i*3+1]);
    mesh.skeleton.bones[i].position.z = parseFloat(positionArray[i*3+2]);
    ...
    points[i].position.set( mesh.skeleton.bones[i].position.x, mesh.skeleton.bones[i].position.y, mesh.skeleton.bones[i].position.z )
...
function render() {
  ...
  display_position( motion_data[1][ current_frame  ], mesh[1] );
  convert_kinect_to_three( motion_data[2][ current_frame +10 ], mesh[2] );
  mesh[1].visible = false

  // convert_kinect_to_three( motion_data[0][ 500 +10 ], mesh[0] );
  // display_position( motion_data[1][ 500  ], mesh[1] );
  // convert_kinect_to_three( motion_data[2][ 500 +10 ], mesh[2] );

  mesh[0].position.set(-0.5, 0, 0);
  mesh[2].position.set(0.5, 0, 0);

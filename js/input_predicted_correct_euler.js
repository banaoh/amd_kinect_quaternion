...
// loader.load("model/kinect_banaoh.js", function(geometry, mats) {
  ...
  // filename[0] = "../datas/converted_norot_dataset/euler/inputs/kinect_17_euler.csv";
  // filename[1] = "../datas/predicted/X_test_kinect_17_euler.csv";
  // filename[2] = "../datas/converted_norot_dataset/euler/corrects/mocap_17_euler.csv";

  var filenum = "10";
  filename[0] = "../datas/converted_norot_dataset/kinect_"+ filenum +".csv";
  filename[1] = "../datas/converted_norot_dataset/euler/inputs/kinect_"+ filenum +"_euler.csv";
  filename[2] = "../datas/predicted/X_test_kinect_17_euler_5000.csv";
  filename[3] = "../datas/converted_norot_dataset/mocap_"+ filenum +".csv";
  filename[4] = "../datas/converted_norot_dataset/euler/corrects/mocap_"+ filenum +"_euler.csv";
  ...
  for (var i = 0; i < mesh.length; i++) {
    ...
    mesh[i].skeleton.bones[0].position.set(i*8-16, 0, 0);
...
function convertEulerToQuaternionNorotRoot(quaArray){
...
function render() {
  ...
  // convert_kinect_to_three( motion_data[2][current_frame + kinect_add_frame + both_add_frame +10 ], mesh[2] );

  // console.log(motion_data[0][ current_frame ]);
  // console.log(convertEulerToQuaternion(motion_data[1][ current_frame ]));

  // console.log(motion_data[0][ current_frame +10 ].length);
  // console.log(motion_data[1][ current_frame +10 ].length);
  // console.log(motion_data[2][ current_frame +10 ].length);

  convert_kinect_to_three( motion_data[0][ current_frame +10 ], mesh[0] );
  convert_kinect_to_three( convertEulerToQuaternion(motion_data[1][ current_frame +10 ]), mesh[1] );
  convert_kinect_to_three( convertEulerToQuaternionNorotRoot(motion_data[2][ current_frame ]), mesh[2] );
  convert_kinect_to_three( motion_data[3][ current_frame +10 ], mesh[3] );
  convert_kinect_to_three( convertEulerToQuaternion(motion_data[4][ current_frame +10 ]), mesh[4] );


  // convert_kinect_to_three( motion_data[0][ current_frame +10 ], mesh[0] );
  // convert_kinect_to_three( motion_data[2][ current_frame +10 ], mesh[2] );

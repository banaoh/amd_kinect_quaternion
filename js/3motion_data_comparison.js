...
webglcamera.position.set(0, 5, 50);
...
// loader.load("model/kinect_v2_banaoh_bone.js", function(geometry, mats) {
  ...
  // var filenum = "0510";
  var filenum = "0516";
  // filename[0] = "../datas/outputs/kinect-2017-0706-" + filenum + "_formatted.csv";
  // filename[1] = "../datas/predicted/X_test_kinect-2017-0706-" + filenum + "_onehour.csv";
  filename[2] = "../datas/predicted/X_test_kinect-2017-0706-" + filenum + "_twohour.csv";
  // filename[3] = "../datas/converted_data/mocap-2017-0706-" + filenum + "_formatted_converted.csv";

  // =============
  filename[0] = "../datas/test_kinect_sortindex.csv";
  filename[1] = "../datas/test_kinect_sortindex.csv";

  // filename[0] = "../datas/outputs/kinect_14_formatted.csv";
  // filename[1] = "../datas/outputs/kinect_14_formatted.csv";
  // =============
  ...
  // filename[1] = "../datas/test_kinect_sortindex.csv";
  // filename[1] = "../datas/test_data_cut2_con2.csv";
  filename[3] = "../datas/test_data_cut2.csv";

  // var fileindex = "09";
  // var fileindex2 = "10";
  // filename[0] = "../datas/check/kinect_" + fileindex + "_formatted.csv";
  // filename[1] = "../datas/check/mocap_" + fileindex + "_cut_converted.csv";
  // filename[2] = "../datas/check/kinect_" + fileindex2 + "_formatted.csv";
  // filename[3] = "../datas/check/mocap_" + fileindex2 + "_cut_converted.csv";

  // filename[2] = "../datas/check/mocap_" + fileindex2 + "_cut_converted2.csv";
  // filename[3] = "../datas/outputs/mocap_10_cut.csv";

  var fileindex = "04";
  // filename[1] = "../datas/check/mocap_" + fileindex + "_cut_converted.csv";
  // filename[0] = "../datas/check/kinect_" + fileindex + "_formatted.csv";
  // filename[1] = "../datas/outputs/kinect_" + fileindex + "_formatted.csv";
  // filename[2] = "../datas/check/mocap_" + fileindex + "_cut_converted.csv";
  // filename[3] = "../datas/check/mocap_" + fileindex + "_cut_converted.csv";


  // var filenum_2 = "04";
  // filename[0] = "../datas/outputs/kinect_" + filenum + "_formatted.csv";
  // filename[1] = "../datas/converted_data/mocap_" + filenum + "_cut_converted.csv";

  // filename[2] = "../datas/outputs/kinect_" + filenum_2 + "_formatted.csv";
  // filename[3] = "../datas/converted_data/mocap_" + filenum_2 + "_cut_converted.csv";
  ...
  for (var i = 0; i < mesh.length; i++) {
    ...
    mesh[i].skeleton.bones[0].position.set(i*10-15, 0, 0);
...
function convert_kinect_to_three2( quaternionArray, mesh ) {
  ...
  threeObjToKinectObj[12] = new THREE.Quaternion().setFromEuler(new THREE.Euler(0, -Math.PI, Math.PI / 2, "XYZ")); // HipLeft --- 0が入るべき
  threeObjToKinectObj[13] = new THREE.Quaternion().setFromEuler(new THREE.Euler(0, -Math.PI / 2, 0, "XYZ")); // KneeLeft
  threeObjToKinectObj[14] = new THREE.Quaternion().setFromEuler(new THREE.Euler(0, -Math.PI / 2, Math.PI, "XYZ")); // AnkleLeft
  threeObjToKinectObj[15] = new THREE.Quaternion().setFromEuler(new THREE.Euler(0, -Math.PI / 2, Math.PI, "XYZ")); // AnkleLeft
  ...
  three_rotq3[17] = erot; // HL --- 0が入るべき
  // three_rotq3[17] = new THREE.Quaternion().multiplyQuaternions( three_rotq2[12].inverse(), three_rotq2[13] ); // KR
  three_rotq3[18] = new THREE.Quaternion().multiplyQuaternions( erot, three_rotq2[12] ); // KL
  ...
  // three_rotq3[19] = erot; // AL
  // three_rotq3[19] = new THREE.Quaternion().setFromEuler(new THREE.Euler(0, Math.PI/2, 0, "XYZ")); // AL
  three_rotq3[19] = new THREE.Quaternion().multiplyQuaternions( three_rotq2[12].inverse(), three_rotq2[13] ); // AL
  three_rotq3[20] = erot; // AL

  three_rotq3[21] = erot; // HR --- 0が入るべき
  // three_rotq3[22] = new THREE.Quaternion().multiplyQuaternions( three_rotq2[16].inverse(), three_rotq2[17] ); // KR
  three_rotq3[22] = new THREE.Quaternion().multiplyQuaternions( erot.inverse(), three_rotq2[16] ); // KR
...
function render() {
  ...
  // 変換を確認用
  convert_kinect_to_three2( motion_data[0][current_frame + kinect_add_frame + both_add_frame ], mesh[1] );
  convert_kinect_to_three( motion_data[1][current_frame + kinect_add_frame + both_add_frame  ], mesh[0] );
  // convert_kinect_to_three( motion_data[2][current_frame + kinect_add_frame + both_add_frame  ], mesh[2] );
  // convert_kinect_to_three( motion_data[3][current_frame + kinect_add_frame + both_add_frame +10 ], mesh[3] );
  // mocap_to_three( motion_data[3][current_frame + kinect_add_frame + both_add_frame  ], mesh[3] );




  // console.log(mesh[2].skeleton.bones[21].quaternion);
  ...
  // console.log(mesh[0].skeleton.bones);
  console.log(mesh[1].skeleton.bones);
  // console.log(mesh[3].skeleton.bones);
